...
var make_parse = function () {
	...
	// special symbols
	symbol("(end)");
	do_infixL("(start)", MAX_BP + 1, ["LAMB"]); symbol_table["(start)"].lef_rbp = MAX_BP + 1;
	do_infixL("(:)", 185, ["LAMB"]); symbol_table["(:)"].lef_rbp = 185;
	...
	do_infixN("=", 190, ["LAMB"]);
	do_infixR("?", 185, [":", symbol_table["(:)"]]); symbol(":"); symbol_table["?"].lef_rbp = MAX_BP + 1;
