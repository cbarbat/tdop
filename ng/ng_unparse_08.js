	...
	var unparse_add = function (element) {
		...
		for (i=1; i<element.args.length; i++)
			if ((element.args[i].node === "Operator" && element.args[i].value === "*" && 
				...
				(element.args[i].node === "Operator" && element.args[i].value === "-"))
			...
			for (i=1; i<element.args.length; i++) 
				if (element.args[i].node === "Operator" && element.args[i].value === "^" && 
			       ((element.args[i].right.node === "Number" && element.args[i].right.value === -1) || 
				    (element.args[i].right.node === "Operator" && element.args[i].right.value === "-" && element.args[i].right.right.node === "Number" && element.args[i].right.right.value === 1 ))) {
